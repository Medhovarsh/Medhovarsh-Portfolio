        ...
        <AnimatePresence>
            {isVisible && (
                <motion.div
                    ...
                    className="fixed bottom-6 left-6 z-[9999] flex flex-col-reverse items-start gap-2 pointer-events-none select-none font-mono text-[10px] tracking-wide max-w-[calc(100vw-3rem)] overflow-hidden"
                >
                    {/* Main HUD Bar */}
                    <div
